...
router.post("/", authGuard, roleGuard("admin", "provider"), validateJoi(createServiceSchema), addMobileAppService);
router.get("/", getMobileAppServices);
router.get("/:id", getOneMobileAppService);
router.put("/:id", authGuard, roleGuard("admin", "provider"), ownerGuard, validateJoi(updateServiceSchema), updateMobileAppService);
router.delete("/:id", authGuard, roleGuard("admin", "provider"), ownerGuard, deleteMobileAppService);
